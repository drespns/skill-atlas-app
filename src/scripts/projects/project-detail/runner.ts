...
export function disableProjectDetailUi(message: string) {
  document.querySelectorAll<HTMLElement>(
    "[data-project-edit-feedback],[data-project-tech-feedback],[data-project-concept-feedback],[data-project-embed-feedback],[data-project-cover-feedback]",
  ).forEach((node) => {
  ...
  document
    .querySelectorAll<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>(
      "[data-project-tech-form] select,[data-project-concept-form] select,[data-project-tech-form] button,[data-project-concept-form] button,[data-project-evidence-quick-url],[data-project-cover-file]",
    )
