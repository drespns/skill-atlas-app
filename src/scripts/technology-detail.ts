...
async function initConceptForm() {
  ...
  form.addEventListener("submit", async (event) => {
    ...
    // Avoid duplicates per technology (same title, case-insensitive).
...
async function initConceptActions() {
...
if (document.readyState === "loading") {
  document.addEventListener("DOMContentLoaded", () => {
    void initConceptForm();
    void initConceptActions();
  });
} else {
  void initConceptForm();
  void initConceptActions();
